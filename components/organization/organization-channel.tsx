...
interface organizationChannelProps {
  channel: Channel;
  role?: MemberRole;
  server: Server;
}
...
export const OrganizationChannel = ({
  channel,
  server,
  role,
}: organizationChannelProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "group px-1 py-1 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
